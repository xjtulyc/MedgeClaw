...
description: >
  ...
  GTEx, eQTL Catalogue, and more. Takes an rsID and queries databases in parallel, returning unified GWAS associations,
  PheWAS results, eQTL data, and fine-mapping credible sets.
  Input: rsID (e.g., rs3798220). Output: markdown report, CSV tables, and figures.
  Trigger keywords: GWAS lookup, variant lookup, rsID search, PheWAS, eQTL, GWAS Catalog, Open Targets.
  变异查询, 全基因组关联研究.
version: 0.1.0
metadata:
  openclaw:
