...
description: >
  Ancestry decomposition PCA against the Simons Genome Diversity Project (SGDP) — 345 samples from 164 populations.
  Places your study cohort in global genetic context by computing joint PCA, generating publication-quality
  multi-panel figures with confidence ellipses, and producing a markdown report with variance explained and
  population assignments.
  Input: VCF file + population map (TSV). Output: multi-panel PCA figure (PNG/PDF), markdown report,
  reproducibility bundle.
  Trigger keywords: ancestry PCA, population structure, SGDP, global diversity, population genetics.
  祖源PCA, 群体结构.
version: 0.1.0
metadata:
  openclaw:
