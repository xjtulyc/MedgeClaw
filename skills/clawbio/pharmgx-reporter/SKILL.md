...
description: >
  ...
  Generates personalised drug-gene interaction reports grounded in CPIC guidelines and FDA-approved PGx biomarkers.
  Input: 23andMe or AncestryDNA raw genotype file. Output: structured report with gene profiles, drug recommendations, and clinical alerts.
  Trigger keywords: pharmacogenomics, drug interactions, 23andMe medications, CYP2D6, CYP2C19, warfarin, CPIC,
  precision-medicine, DTC-genetics.
  药物基因组, 用药指导, 个性化医疗.
version: 0.1.0
metadata:
  openclaw:
