...
description: >
  ...
  synthesizes all skill results (PharmGx, NutriGx, PRS, Genome Compare) into a
  single "Your Genomic Profile" document with cross-domain insights and executive
  summary. Handles graceful degradation when only some skills have been run.
  Triggers: profile report, unified report, my profile, genomic profile,
  personal profile, report synthesis, personal genomics.
  触发关键词: 个人基因组报告, 基因档案.
version: 0.1.0
metadata:
  openclaw:
