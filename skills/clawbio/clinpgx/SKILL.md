...
description: >
  ...
  Looks up gene-drug interactions, allele definitions, and clinical practice guidelines from the ClinPGx REST API.
  Input: gene symbols (e.g., CYP2D6) or drug names (e.g., warfarin). Output: markdown report with CSV tables.
  Trigger keywords: ClinPGx, PharmGKB, gene-drug pair, CPIC guideline, drug label, pharmacogene.
  基因-药物数据库, 临床药物基因组.
version: 0.1.0
metadata:
  openclaw:
